...
close1 = driver.find_element(by=By.XPATH, value="//div[@id='myModalClick']//button[@type='button'][normalize-space()='Close']")
...
close2 = driver.find_element(by=By.XPATH, value="//div[@class='modal-dialog modal-md']//button[@type='button'][normalize-space()='Close']")
...
close3 = driver.find_element(by=By.XPATH, value="//div[@id='myModalMoveClick']//button[@type='button'][normalize-space()='Close']")
