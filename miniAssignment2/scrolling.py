...
class scrollingaround:
    ...
    try:
        ...
        action.move_to_element(driver.find_element(by=By.XPATH, value="//div[@id='zone1']")).move_to_element(
            driver.find_element(by=By.XPATH, value="//h1[@id='zone3-entries']")).move_to_element(
            driver.find_element(by=By.XPATH, value="//h1[@id='zone2-entries']")).move_to_element(
            driver.find_element(by=By.XPATH, value="//div[@id='zone4']")).move_to_element(
            driver.find_element(by=By.XPATH, value="//h1[@id='zone2-entries']")).perform()
